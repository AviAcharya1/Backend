...
const swaggerDoc = require('./helper/swaggerSetup');
...
app.use('/ad', require('./routes/ad.routes'));
app.use('/bid', require('./routes/bid.routes'));
app.use('/room', require('./routes/bid.routes'));
